...
* Error
  * Elastic Beanstalk 배포  
    * requirements.txt error 
    ![](images/4월/4월_1일/elasticbeanstalk_requirements_awsebcli_version_confilct.PNG)
    ![](images/4월/4월_1일/fail_to_launch_enviroment.PNG)
    ![](images/4월/4월_1일/no_module_django.PNG)
    ![](images/4월/4월_1일/pyproject_tomi_error.PNG)
  * 
  * `Router53` 도메인 lock - `Github`에 `IAM` 사용자 KEY를 올리게 되면 계정이 잠금(?)처리가 된다.
  ![](images/4월/4월_1일/aws_lock.png)
...
* error
  * ![](images/4월/4월_7일/too_long_error.png)
...
* Error 
  * ELB 오류 수정 
    ![img.png](images/4월/4월_20일/ELB_오류.png)
    * 해당 오류는 서브넷을 추가 하지 않아서 생기는 문제였다.
  * Django, https연결 시 CSRF Token 설정 
  ![img.png](images/4월/4월_20일/django_csrf_origin_setting.png)
